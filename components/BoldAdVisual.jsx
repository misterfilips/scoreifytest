...
import { useInView, FloatCard, AdFrame, ArrowUp, CheckMark } from "./AdVisualKit";
...
export default function BoldAdVisual() {
  ...
  return (
    <div ref={ref} className="relative mx-auto max-w-md px-6 py-8 sm:px-10">
      ...
      <AdFrame
        src="/peptide-bold.png"
        alt="Bold before-and-after weight-loss Meta ad approved on a trusted Scoreify account"
      />
      ...
      <FloatCard inView={inView} delay={150} float="animate-float" className="-left-2 top-14 sm:-left-7">
        <div className="w-44 rounded-2xl border border-slate-200 bg-white/95 p-3.5 shadow-xl shadow-slate-300/50 backdrop-blur">
          ...
          <div className="mt-2.5 space-y-1.5">
            <CheckRow label="Before / after format" />
      ...
      <FloatCard inView={inView} delay={320} float="animate-float-rev" className="-right-2 bottom-14 sm:-right-7">
        <div className="w-40 rounded-2xl border border-slate-200 bg-white/95 p-3.5 shadow-xl shadow-slate-300/50 backdrop-blur">
          ...
          {/* rising sparkline that draws in on reveal */}
          <svg viewBox="0 0 120 34" className="mt-2 h-9 w-full" fill="none" preserveAspectRatio="none">
            <polyline
              ...
              style={{
                ...
                transition: "stroke-dashoffset 1100ms ease-out 450ms",
              }}
            />
            <defs>
